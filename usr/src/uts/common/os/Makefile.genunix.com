...
# XXXARM: This is ARM-only right now, with the NetBSD genassym
...
# XXXARM: This is because AArch64 puts floating point handling in genunix not
# unix, where nobody else does.
$(OBJS_DIR)/%.o:		$(UTSBASE)/$(UTSMACH)/ml/%.S
	$(COMPILE.s) -o $@ $<
