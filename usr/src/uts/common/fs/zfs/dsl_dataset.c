...
dsl_dataset_evict(void *dbu)
{
	...
	trackcount_destroy(&ds->ds_longholds);
    ...
    dsl_dataset_t **dsp)
{
	...
	if (ds == NULL) {
		...
		trackcount_create(&ds->ds_longholds);
...
dsl_dataset_long_hold(dsl_dataset_t *ds, void *tag)
{
	...
	(void) trackcount_add(&ds->ds_longholds, tag);
}

void
dsl_dataset_long_rele(dsl_dataset_t *ds, void *tag)
{
	(void) trackcount_remove(&ds->ds_longholds, tag);
}
...
{
	return (!trackcount_is_zero(&ds->ds_longholds));
}
