...
static const sl_prgregset_layout_t prgregset_layout = {
	{ 0,	288,	0,	0 },		/* sizeof (prgregset_t) */
	{ 0,	8,	36,	0 },		/* elt0 */
};


static const sl_lwpstatus_layout_t lwpstatus_layout = {
	{ 0,	1360,	0,	0 },		/* sizeof (lwpstatus_t) */
	{ 0,	4,	0,	0 },		/* pr_flags */
	{ 4,	4,	0,	0 },		/* pr_lwpid */
	{ 8,	2,	0,	0 },		/* pr_why */
	{ 10,	2,	0,	0 },		/* pr_what */
	...
	{ 536,	8,	0,	0 },		/* pr_instr */
	{ 544,	288,	0,	0 },		/* pr_reg */
	{ 832,	528,	0,	0 },		/* pr_fpreg */
};


static const sl_pstatus_layout_t pstatus_layout = {
	{ 0,	1744,	0,	0 },		/* sizeof (pstatus_t) */
	{ 0,	4,	0,	1 },		/* pr_flags */
	{ 4,	4,	0,	1 },		/* pr_nlwp */
	{ 8,	4,	0,	0 },		/* pr_pid */
	{ 12,	4,	0,	0 },		/* pr_ppid */
...
static const sl_arch_layout_t layout_aarch64 = {
	&auxv_layout,
	&fltset_layout,
	&lwpsinfo_layout,
	&lwpstatus_layout,
...
struct_layout_aarch64(void)
{
	return (&layout_aarch64);
}
