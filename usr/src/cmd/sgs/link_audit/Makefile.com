...
ROOTDBG=		$(ROOT)/usr/lib/debug/usr/lib/link_audit
ROOTCCSLIB64=		$(ROOT)/usr/lib/link_audit/$(MACH64)
ROOTDBG64=		$(ROOT)/usr/lib/debug/usr/lib/link_audit/$(MACH64)
ROOTCCSLIBS=		$(CCSLIBS:%=$(ROOTCCSLIB)/%) $(CCSLIBS:%=$(ROOTDBG)/%)
ROOTCCSLIBS64=		$(CCSLIBS:%=$(ROOTCCSLIB64)/%) $(CCSLIBS:%=$(ROOTDBG64)/%)
