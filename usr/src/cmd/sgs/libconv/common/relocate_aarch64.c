...
/*
 * String conversion routine for AArch64 relocation types
 */
...
static const Msg rels[R_AARCH64_NUM] = {
	...
	[R_AARCH64_ALSO_NONE]				= MSG_R_AARCH64_ALSO_NONE,
	...
	[R_AARCH64_GOTPCREL32]				= MSG_R_AARCH64_GOTPCREL32,
	...
	[R_AARCH64_AUTH_ABS64]				= MSG_R_AARCH64_AUTH_ABS64,
	[R_AARCH64_AUTH_MOVW_GOTOFF_G0]			= MSG_R_AARCH64_AUTH_MOVW_GOTOFF_G0,
	[R_AARCH64_AUTH_MOVW_GOTOFF_G0_NC]		= MSG_R_AARCH64_AUTH_MOVW_GOTOFF_G0_NC,
	[R_AARCH64_AUTH_MOVW_GOTOFF_G1]			= MSG_R_AARCH64_AUTH_MOVW_GOTOFF_G1,
	[R_AARCH64_AUTH_MOVW_GOTOFF_G1_NC]		= MSG_R_AARCH64_AUTH_MOVW_GOTOFF_G1_NC,
	[R_AARCH64_AUTH_MOVW_GOTOFF_G2]			= MSG_R_AARCH64_AUTH_MOVW_GOTOFF_G2,
	[R_AARCH64_AUTH_MOVW_GOTOFF_G2_NC]		= MSG_R_AARCH64_AUTH_MOVW_GOTOFF_G2_NC,
	[R_AARCH64_AUTH_MOVW_GOTOFF_G3]			= MSG_R_AARCH64_AUTH_MOVW_GOTOFF_G3,
	[R_AARCH64_AUTH_GOT_LD_PREL19]			= MSG_R_AARCH64_AUTH_GOT_LD_PREL19,
	[R_AARCH64_AUTH_LD64_GOTOFF_LO15]		= MSG_R_AARCH64_AUTH_LD64_GOTOFF_LO15,
	[R_AARCH64_AUTH_ADR_GOT_PAGE]			= MSG_R_AARCH64_AUTH_ADR_GOT_PAGE,
	[R_AARCH64_AUTH_LD64_GOT_LO12_NC]		= MSG_R_AARCH64_AUTH_LD64_GOT_LO12_NC,
	[R_AARCH64_AUTH_LD64_GOTPAGE_LO15]		= MSG_R_AARCH64_AUTH_LD64_GOTPAGE_LO15,
	[R_AARCH64_AUTH_GOT_ADD_LO12_NC]		= MSG_R_AARCH64_AUTH_GOT_ADD_LO12_NC,
	[R_AARCH64_AUTH_GOT_ADR_PREL_LO21]		= MSG_R_AARCH64_AUTH_GOT_ADR_PREL_LO21,
	[R_AARCH64_AUTH_TLSDESC_ADR_PAGE21]		= MSG_R_AARCH64_AUTH_TLSDESC_ADR_PAGE21,
	[R_AARCH64_AUTH_TLSDESC_LD64_LO12]		= MSG_R_AARCH64_AUTH_TLSDESC_LD64_LO12,
	[R_AARCH64_AUTH_TLSDESC_ADD_LO12]		= MSG_R_AARCH64_AUTH_TLSDESC_ADD_LO12,
	[R_AARCH64_PATCHINST]				= MSG_R_AARCH64_PATCHINST,
	[R_AARCH64_FUNCINIT64]				= MSG_R_AARCH64_FUNCINIT64,
	[R_AARCH64_AUTH_RELATIVE]			= MSG_R_AARCH64_AUTH_RELATIVE,
	[R_AARCH64_AUTH_GLOB_DAT]			= MSG_R_AARCH64_AUTH_GLOB_DAT,
	[R_AARCH64_AUTH_TLSDESC]			= MSG_R_AARCH64_AUTH_TLSDESC,
	[R_AARCH64_AUTH_IRELATIVE]			= MSG_R_AARCH64_AUTH_IRELATIVE,
    ...
    Conv_inv_buf_t *inv_buf)
{
	...
	/* The AArch64 relocation table is unfortunately sparse */
	if (rels[type] == 0)
		return (conv_invalid_val(inv_buf, type, fmt_flags));
